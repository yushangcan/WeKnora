...
func TestTenantInfrastructureRoutesDeclareSpecificCapabilities(t *testing.T) {
	...
	cases := []struct {
		...
		{http.MethodGet, "/api/v1/evaluation/runs/:run_id", types.APIKeyCapabilityRunEvaluations},
		{http.MethodGet, "/api/v1/evaluation/runs/:run_id/cases", types.APIKeyCapabilityRunEvaluations},
		{http.MethodGet, "/api/v1/evaluation/comparison", types.APIKeyCapabilityRunEvaluations},
